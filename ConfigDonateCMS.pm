...
$cfg->{projectName}       = "UniversalStudio"; # Название проекта
$cfg->{baseUrl}           = "http://five.u-studio.su/"; # Адрес сайта, например,
$cfg->{adminEmail}        = ""; # Адрес электронной почты администратора сервера
$cfg->{adminSkype}        = ""; # Скайп Администратора сервера
$cfg->{adminVK}           = "http://vk.com/universalstudio"; # ВК администратора сервера (ссылка)
$cfg->{dateOfCreation}     = "25.03.2020"; #дата создания проекта

$cfg->{serverIp}          = "funmc.su"; # IP-адрес вашего сервера Майнкрафт
$cfg->{serverPort}        = "25565"; # Порт вашего сервера Майнкрафт

$cfg->{dbServer}          = "localhost"; # Адрес сервера MySQL, например, localhost 
$cfg->{dbName}            = ""; # Название базы данных MySQL
$cfg->{dbUser}            = ""; # Имя пользователя базы данных MySQL
$cfg->{dbPassword}        = ""; # Пароль от базы данных MySQL
$cfg->{cpUser}            = "universalstudio"; # Логин от панели управления доступна по адресу http://адрес.сайта/cpanel/
$cfg->{cpPassword}        = "test"; # Пароль от панели управления
$cfg->{templatePath}      = "template/universalstudio"; # Название шаблона сайта, хранится в папке template
...
$cfg->{unitpayPublicKey}  = ""; # Заполнять, если $cfg->{payment} == unitpay
$cfg->{unitpaySecretKey}  = ""; # Заполнять, если $cfg->{payment} == unitpay
...
$cfg->{serverVK} = qq{http://vk.com/universalstudio};
